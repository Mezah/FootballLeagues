...
//            val team = client.getTeamInformation(teamId.toString()).blockingGet()
//
...
//        val response = client.getTierOneLeaguesList().blockingGet()
...
//        val teamsInLeague = client.getTeamsListInLeagues(leagueId).blockingGet()
